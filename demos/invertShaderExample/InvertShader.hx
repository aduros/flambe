package invertShaderExample;
    ...
    class InvertShader extends Shader implements ShaderHXSL
    {
        ...
        static var SRC = {
            ...
            function fragment (texture :Texture)
            {
                ...
                out =   (color.a > 0) * [1.0 - color.r, 1.0 - color.g, 1.0 - color.b, color.a] +
                        (color.a <= 0) * [0,0,0,0];
            }
        }
    ...
    class InvertShader extends ShaderGL
    {
        public function new (gl :RenderingContext)
        {
            ...
            [ // Fragment shader
                ...
                "void main (void) {",
                    "vec4 color = texture2D(u_texture, v_uv) * v_alpha;",
